...
/* harmony import */ var quill_quill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! quill/quill */ "./node_modules/quill/quill.js");

window.Quill = quill_quill__WEBPACK_IMPORTED_MODULE_0__.default;
...
class Image extends (parchment__WEBPACK_IMPORTED_MODULE_0___default().Embed) {
  static create(value) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IndentClass": () => (/* binding */ IndentClass)
/* harmony export */ });
/* harmony import */ var parchment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! parchment */ "./node_modules/parchment/dist/parchment.js");
/* harmony import */ var parchment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(parchment__WEBPACK_IMPORTED_MODULE_0__);


class IdentAttributor extends (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class) {
  add(node, value) {
    if (value === '+1' || value === '-1') {
...
class List extends _blots_container__WEBPACK_IMPORTED_MODULE_2__.default {
  ...
  constructor(domNode) {
    ...
    const listEventHandler = (e) => {
      ...
      let blot = parchment__WEBPACK_IMPORTED_MODULE_0___default().find(e.target);
      if (format === 'checked') {
  ...
  replace(target) {
    if (target.statics.blotName !== this.statics.blotName) {
      let item = parchment__WEBPACK_IMPORTED_MODULE_0___default().create(this.statics.defaultChild);
...
class Video extends _blots_block__WEBPACK_IMPORTED_MODULE_0__.BlockEmbed {
  ...
  static sanitize(url) {
    return _formats_link__WEBPACK_IMPORTED_MODULE_1__.default.sanitize(url);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FormulaBlot": () => (/* binding */ FormulaBlot),
...
class FormulaBlot extends _blots_embed__WEBPACK_IMPORTED_MODULE_0__.default {
  static create(value) {
    let node = super.create(value);
    if (typeof value === 'string') {
...
class Formula extends _core_module__WEBPACK_IMPORTED_MODULE_2__.default {
  static register() {
    _core_quill__WEBPACK_IMPORTED_MODULE_1__.default.register(FormulaBlot, true);
  }
...
class SyntaxCodeBlock extends _formats_code__WEBPACK_IMPORTED_MODULE_3__.default {
  replaceWith(block) {
...
let CodeToken = new (parchment__WEBPACK_IMPORTED_MODULE_0___default().Attributor.Class)('token', 'hljs', {
  scope: (parchment__WEBPACK_IMPORTED_MODULE_0___default().Scope.INLINE)
});


class Syntax extends _core_module__WEBPACK_IMPORTED_MODULE_2__.default {
  static register() {
    _core_quill__WEBPACK_IMPORTED_MODULE_1__.default.register(CodeToken, true);
    _core_quill__WEBPACK_IMPORTED_MODULE_1__.default.register(SyntaxCodeBlock, true);
  }
  ...
  constructor(quill, options) {
    ...
    let timer = null;
    this.quill.on(_core_quill__WEBPACK_IMPORTED_MODULE_1__.default.events.SCROLL_OPTIMIZE, () => {
      clearTimeout(timer);
      timer = setTimeout(() => {
        this.highlight();
        timer = null;
  ...
  highlight() {
    ...
    this.quill.update(_core_quill__WEBPACK_IMPORTED_MODULE_1__.default.sources.SILENT);
    if (range != null) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "./node_modules/quill/core.js");
/* harmony import */ var _formats_align__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formats/align */ "./node_modules/quill/formats/align.js");
/* harmony import */ var _formats_direction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formats/direction */ "./node_modules/quill/formats/direction.js");
/* harmony import */ var _formats_indent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./formats/indent */ "./node_modules/quill/formats/indent.js");
/* harmony import */ var _formats_blockquote__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./formats/blockquote */ "./node_modules/quill/formats/blockquote.js");
/* harmony import */ var _formats_header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./formats/header */ "./node_modules/quill/formats/header.js");
/* harmony import */ var _formats_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./formats/list */ "./node_modules/quill/formats/list.js");
/* harmony import */ var _formats_background__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./formats/background */ "./node_modules/quill/formats/background.js");
/* harmony import */ var _formats_color__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./formats/color */ "./node_modules/quill/formats/color.js");
/* harmony import */ var _formats_font__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./formats/font */ "./node_modules/quill/formats/font.js");
/* harmony import */ var _formats_size__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./formats/size */ "./node_modules/quill/formats/size.js");
/* harmony import */ var _formats_bold__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./formats/bold */ "./node_modules/quill/formats/bold.js");
/* harmony import */ var _formats_italic__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./formats/italic */ "./node_modules/quill/formats/italic.js");
/* harmony import */ var _formats_link__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./formats/link */ "./node_modules/quill/formats/link.js");
/* harmony import */ var _formats_script__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./formats/script */ "./node_modules/quill/formats/script.js");
/* harmony import */ var _formats_strike__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./formats/strike */ "./node_modules/quill/formats/strike.js");
/* harmony import */ var _formats_underline__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./formats/underline */ "./node_modules/quill/formats/underline.js");
/* harmony import */ var _formats_image__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./formats/image */ "./node_modules/quill/formats/image.js");
/* harmony import */ var _formats_video__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./formats/video */ "./node_modules/quill/formats/video.js");
/* harmony import */ var _formats_code__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./formats/code */ "./node_modules/quill/formats/code.js");
/* harmony import */ var _modules_formula__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/formula */ "./node_modules/quill/modules/formula.js");
/* harmony import */ var _modules_syntax__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/syntax */ "./node_modules/quill/modules/syntax.js");
/* harmony import */ var _modules_toolbar__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/toolbar */ "./node_modules/quill/modules/toolbar.js");
/* harmony import */ var _ui_icons__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./ui/icons */ "./node_modules/quill/ui/icons.js");
/* harmony import */ var _ui_icons__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_ui_icons__WEBPACK_IMPORTED_MODULE_23__);
/* harmony import */ var _ui_picker__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./ui/picker */ "./node_modules/quill/ui/picker.js");
/* harmony import */ var _ui_color_picker__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./ui/color-picker */ "./node_modules/quill/ui/color-picker.js");
/* harmony import */ var _ui_icon_picker__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./ui/icon-picker */ "./node_modules/quill/ui/icon-picker.js");
/* harmony import */ var _ui_tooltip__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./ui/tooltip */ "./node_modules/quill/ui/tooltip.js");
/* harmony import */ var _themes_bubble__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./themes/bubble */ "./node_modules/quill/themes/bubble.js");
/* harmony import */ var _themes_snow__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./themes/snow */ "./node_modules/quill/themes/snow.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__.default.register({
  ...
  'formats/indent': _formats_indent__WEBPACK_IMPORTED_MODULE_3__.IndentClass,
  ...
  'formats/code-block': _formats_code__WEBPACK_IMPORTED_MODULE_19__.default,
  ...
  'formats/code': _formats_code__WEBPACK_IMPORTED_MODULE_19__.Code,
  ...
  'formats/image': _formats_image__WEBPACK_IMPORTED_MODULE_17__.default,
  'formats/video': _formats_video__WEBPACK_IMPORTED_MODULE_18__.default,

  'formats/list/item': _formats_list__WEBPACK_IMPORTED_MODULE_6__.ListItem,

  'modules/formula': _modules_formula__WEBPACK_IMPORTED_MODULE_20__.default,
  'modules/syntax': _modules_syntax__WEBPACK_IMPORTED_MODULE_21__.default,
  'modules/toolbar': _modules_toolbar__WEBPACK_IMPORTED_MODULE_22__.default,

  'themes/bubble': _themes_bubble__WEBPACK_IMPORTED_MODULE_28__.default,
  'themes/snow': _themes_snow__WEBPACK_IMPORTED_MODULE_29__.default,

  'ui/icons': (_ui_icons__WEBPACK_IMPORTED_MODULE_23___default()),
  'ui/picker': _ui_picker__WEBPACK_IMPORTED_MODULE_24__.default,
  'ui/icon-picker': _ui_icon_picker__WEBPACK_IMPORTED_MODULE_26__.default,
  'ui/color-picker': _ui_color_picker__WEBPACK_IMPORTED_MODULE_25__.default,
  'ui/tooltip': _ui_tooltip__WEBPACK_IMPORTED_MODULE_27__.default
}, true);
...
/* harmony import */ var _core_selection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/selection */ "./node_modules/quill/core/selection.js");
/* harmony import */ var _ui_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../ui/icons */ "./node_modules/quill/ui/icons.js");
/* harmony import */ var _ui_icons__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_ui_icons__WEBPACK_IMPORTED_MODULE_4__);
...
class BubbleTheme extends _base__WEBPACK_IMPORTED_MODULE_2__.default {
  ...
  extendToolbar(toolbar) {
    ...
    this.buildButtons([].slice.call(toolbar.container.querySelectorAll('button')), (_ui_icons__WEBPACK_IMPORTED_MODULE_4___default()));
    this.buildPickers([].slice.call(toolbar.container.querySelectorAll('select')), (_ui_icons__WEBPACK_IMPORTED_MODULE_4___default()));
  }
}
    ...
    this.quill.on(_core_emitter__WEBPACK_IMPORTED_MODULE_1__.default.events.EDITOR_CHANGE, (type, range, oldRange, source) => {
      ...
      if (range != null && range.length > 0 && source === _core_emitter__WEBPACK_IMPORTED_MODULE_1__.default.sources.USER) {
        ...
        if (lines.length === 1) {
          ...
          let bounds = this.quill.getBounds(new _core_selection__WEBPACK_IMPORTED_MODULE_3__.Range(index, length));
